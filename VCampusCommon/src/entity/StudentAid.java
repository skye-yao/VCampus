...
public class StudentAid implements Serializable {
    ...
    private Long aidId;
    private String studentId,aidName,aidType,provider,description;
    ...
    public void setAidName(String v) {
        aidName=v;
    }
    public String getAidType() {
        return aidType;
    }
    public void setAidType(String v) {
        aidType=v;
    }
    ...
    public StudentAidStatus getStatus() {
        return status;
    }
    public void setStatus(StudentAidStatus v) {
        status=v;
    }
