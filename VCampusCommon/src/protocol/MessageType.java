...
LOCK_ACQUIRE, LOCK_RENEW, LOCK_RELEASE,
...
TEACHER_ADMIN_UPDATE, TEACHER_CHANGE_CANCEL,
...
SHOP_PRODUCT_REVIEW_LIST,           // 查询商品评价
SHOP_PRODUCT_REVIEW_ADD,            // 发表商品评价（需已购买）
SHOP_PRODUCT_REVIEW_DELETE,         // 删除商品评价（作者或管理员）
