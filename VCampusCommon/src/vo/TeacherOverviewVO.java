...
public class TeacherOverviewVO implements Serializable {
 ...
 private static final long serialVersionUID=1L; private Teacher teacher; private TeacherChangeRequest pendingRequest;private java.util.List<TeacherWorkExperience> workExperiences=new java.util.ArrayList<>();private java.util.List<TeacherFamilyMember> familyMembers=new java.util.ArrayList<>();
 ...
 public java.util.List<TeacherFamilyMember> getFamilyMembers(){return familyMembers;}public void setFamilyMembers(java.util.List<TeacherFamilyMember> v){familyMembers=v==null?new java.util.ArrayList<>():v;}
}
