...
public class StudentReviewVO implements Serializable {
    ...
    private long requestId; private StudentChangeStatus reviewResult; private String reviewRemark;
    public long getRequestId(){return requestId;} public void setRequestId(long v){requestId=v;}
    public StudentChangeStatus getReviewResult(){return reviewResult;} public void setReviewResult(StudentChangeStatus v){reviewResult=v;}
