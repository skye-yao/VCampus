...
public class TeacherClientService {private final SocketClient socket=SocketClient.getInstance();
 ...
 public void addFamilyMember(TeacherFamilyMember value,Consumer<Message> callback){send(MessageType.TEACHER_FAMILY_MEMBER_ADD,"addFamilyMember","familyMember",value,callback);}
 public void updateFamilyMember(TeacherFamilyMember value,Consumer<Message> callback){send(MessageType.TEACHER_FAMILY_MEMBER_UPDATE,"updateFamilyMember","familyMember",value,callback);}
 public void deleteFamilyMember(long id,Consumer<Message> callback){send(MessageType.TEACHER_FAMILY_MEMBER_DELETE,"deleteFamilyMember","memberId",Long.toString(id),callback);}}
